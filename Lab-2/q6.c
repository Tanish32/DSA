...
{
    Node *ptr1 = head, *ptr1n = head;
    Node *ptr2 = head->next, *ptr2n = head->next;
    while (ptr1n != NULL && ptr2n != NULL)
    {
        ptr1n->next = ptr2n->next;
        ptr1n = ptr2n->next;
        if (ptr1n == NULL)
        {
            break;
        }
        ptr2n->next = ptr1n->next;
        ptr2n = ptr1n->next;
    }
    ptr1n = ptr1;
    while (ptr1n->next != NULL)
    {
        ptr1n = ptr1n->next;
    }
    ptr1n->next = ptr2;
